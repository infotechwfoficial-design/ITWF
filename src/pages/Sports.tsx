      ...
      <div className="flex flex-col gap-8 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div
            ...
            className="md:col-span-2 rounded-[2.5rem] bg-white/40 dark:bg-slate-900/40 backdrop-blur-md border border-black/5 dark:border-white/5 p-1 overflow-hidden shadow-xl"
          >
